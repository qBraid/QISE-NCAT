...
phase_1 = Slider(start=0, end=6.4, value=0, step=np.pi/8, title="Phase 1")
phase_2 = Slider(start=0, end=6.4, value=0+phi, step=np.pi/8, title="Phase 2")
...
layout = row( column(plot1,plot2), column(phase_1,phase_2) )
