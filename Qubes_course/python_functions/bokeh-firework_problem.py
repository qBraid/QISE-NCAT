...
run.js_event_callbacks(callback_run)
run.js_event_callbacks(callback_message)
reset.js_event_callbacks(callback_reset)
firework_present.js_event_callbacks(callback)
...
sidebar = column(firework_present,splitter_1,splitter_2,row(run,reset),message)
